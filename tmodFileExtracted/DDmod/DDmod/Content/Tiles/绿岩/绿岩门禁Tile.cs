...
{
	public class 绿岩门禁Tile : DDCrystals
    {
        ...
        public override bool WillNoKill => true;
        public override void SetDefaults()
        {
            ...
            DDSystem.Instance.DDEquipGlow.TryGetValue("绿岩门禁", out int GG);
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            {
                if (Main.LocalPlayer.inventory[A].type > 0 && Main.LocalPlayer.inventory[A].type == ModContent.ItemType<绿岩门禁卡>())
                {
            ...
            PlaySound(DDHelper.SoundStyle(1, "解锁失败"), new Vector2(i, j) * 16);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<绿岩门禁卡>();
        }
    }
}
