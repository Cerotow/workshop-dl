...
namespace DDmod.Content.Tiles.农场
{
    public class 荧光果植株 : 作物
    {
        ...
        {
            asset = ModContent.Request<Texture2D>("DDmod/Content/Tiles/农场/荧光果");
            Glow = ModContent.Request<Texture2D>("DDmod/Content/Tiles/农场/荧光果_Glow");
        }
        ...
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            ...
            if (A == 0)
            {
                yield return new Item(ModContent.ItemType<荧光果种子>());
            }
            if (A == Max)
            {
                yield return new Item(ModContent.ItemType<荧光果>());
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            if (A == Max)
            {
                Main.LocalPlayer.QuickSpawnItem(new EntitySource_TileEntity(tepowerCellFactory), ModContent.ItemType<荧光果>(), 1);
