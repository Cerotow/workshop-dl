    ...
    public class 超级胡萝卜Tile : 作物
    {
        ...
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            ...
            if (tile.TileFrameX == 0&&tile.TileFrameY==0)
            {
                ...
                if (A == 0)
                {
                    yield return new Item(ModContent.ItemType<巨大的胡萝卜种子>());
                }
                if (A == 5)
                {
                    yield return new Item(ModContent.ItemType<超级胡萝卜>());
                }
            }
        }
