...
{
    public class 先祖咒魂圣物Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "DDmod/Content/Tiles/Relic/先祖咒魂圣物Tile";
        public virtual string RelicTextureNameGlow => "DDmod/Content/Tiles/Relic/先祖咒魂圣物Tile_Glow";
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconID = ModContent.ItemType<先祖咒魂圣物>();
