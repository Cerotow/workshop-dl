...
{
    public class 矿洞幽魂圣物Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "DDmod/Content/Tiles/Relic/矿洞幽魂圣物Tile";

        public override string Texture => "DDmod/Content/Tiles/Relic/RelicPedestalMini";
