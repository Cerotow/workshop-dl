...
{
    public class 天雷怒云圣物Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "DDmod/Content/Tiles/Relic/天雷怒云圣物Tile";
        public virtual string RelicTextureNameGlow => "DDmod/Content/Tiles/Relic/天雷怒云圣物Tile_Glow";
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconID = ModContent.ItemType<天雷怒云圣物>();
