...
namespace DDmod.Content.Tiles.Relic
{
    public class 鬼牙圣物Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "DDmod/Content/Tiles/Relic/鬼牙圣物Tile";
        public virtual string RelicTextureNameGlow => "DDmod/Content/Tiles/Relic/鬼牙圣物Tile_Glow";
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconID = ModContent.ItemType<鬼牙圣物>();
