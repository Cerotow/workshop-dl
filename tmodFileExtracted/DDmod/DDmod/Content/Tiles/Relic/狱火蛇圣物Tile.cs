...
{
    public class 狱火蛇圣物Tile : ModTile
    {
        ...
        public virtual string RelicTextureName => "DDmod/Content/Tiles/Relic/狱火蛇圣物Tile";
        public virtual string RelicTextureNameGlow => "DDmod/Content/Tiles/Relic/狱火蛇圣物Tile_Glow";
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconID = ModContent.ItemType<狱火蛇圣物>();
