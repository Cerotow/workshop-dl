...
{
	public class 花岗岩科技门关Tile : DDDoorOff
    {
        public override int Icon => ModContent.ItemType<花岗岩科技门>();
        public override int Dust => ModContent.DustType<花岗岩电光粒子>();
        public override Color Color => new Color(100, 155, 255);
        public override int DoorID => ModContent.TileType<花岗岩科技门开Tile>();
        public override int ItemID => Icon;
        public Asset<Texture2D> TileTexture;

        public string T => "DDmod/Content/Tiles/花岗岩基地/花岗岩科技门关_Glow";
