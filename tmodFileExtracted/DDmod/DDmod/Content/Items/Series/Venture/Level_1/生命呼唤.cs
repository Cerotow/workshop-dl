...
namespace DDmod.Content.Items.Series.Venture.Level_1
{
    public class 生命呼唤 : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<LeafCrystal>();
            Item.shootSpeed = 2;
            Item.buffType = ModContent.BuffType<LeafCrystalBuff>();
            AdventureGearGlobalItem.WeaponsQualityAttribute(Item, new Random().Next(5, 10), 0);
        }
