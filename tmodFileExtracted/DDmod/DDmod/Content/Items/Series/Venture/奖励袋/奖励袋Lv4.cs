...
namespace DDmod.Content.Items.Series.Venture.奖励袋
{
    public class 奖励袋Lv4 : ModItem
    {
        ...
        {
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<绿色委托币>(), 1, 16, 24));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<优秀重铸币>(), 1, 8, 12));
            ...
            itemLoot.Add(ItemDropRule.Common(2314, 1, 3, 5));
        }
    }
}
