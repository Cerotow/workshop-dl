...
namespace DDmod.Content.Items.Series.Venture.奖励袋
{
    public class 奖励袋Lv6 : ModItem
    {
        ...
        {
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<蓝色委托币>(), 1, 12, 20));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<完美重铸币>(), 1, 6, 10));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<StrengtheningStone2>(), 1, 1, 2));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<StrengtheningStone3>(), 2, 1, 2));
