...
{
    public class ShadowFlowerItem : ModItem
    {
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.FlowerofFire).AddIngredient(ModContent.ItemType<ShadowFlame>()).AddIngredient(ItemID.Bone, 24).AddTile(TileID.Anvils).Register();
        }
    }
}