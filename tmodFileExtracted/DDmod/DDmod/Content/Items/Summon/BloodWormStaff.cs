...
{
    public class BloodWormStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<BloodWorm>();
            Item.shootSpeed = 2;
            Item.buffType = ModContent.BuffType<BloodWormBuff>();
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.CrimtaneBar, 12).AddIngredient(ItemID.TissueSample, 8).AddTile(TileID.Anvils).Register();
        }
    }
}
