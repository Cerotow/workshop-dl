...
{
    public class TinSwordStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<TinSword>();
            Item.shootSpeed = 2;
            Item.buffType = ModContent.BuffType<TinSwordBuff>();
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.TinBar, 6).AddIngredient(ModContent.ItemType<SoulOfNature>(), 2).AddIngredient(9, 2).AddTile(TileID.Anvils).Register();
        }
    }
}
