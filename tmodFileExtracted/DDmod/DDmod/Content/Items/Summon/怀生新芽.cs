...
namespace DDmod.Content.Items.Summon
{
    public class 怀生新芽 : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<土灵>();
            Item.shootSpeed = 2;
            Item.buffType = ModContent.BuffType<土灵Buff>();
        }
        ...
        {
            CreateRecipe(1).AddIngredient(2, 10).AddIngredient(62, 1).AddIngredient(ModContent.ItemType<SoulOfNature>(), 2).AddTile(TileID.Anvils).Register();
        }
    }
}
