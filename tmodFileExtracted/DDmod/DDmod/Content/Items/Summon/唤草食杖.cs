...
namespace DDmod.Content.Items.Summon
{
    public class 唤草食杖 : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<食人小草>();
            Item.shootSpeed = 2;
            Item.buffType = ModContent.BuffType<食人小草Buff>();
        }
        ...
        {
            CreateRecipe(1).AddIngredient(331, 10).AddIngredient(210, 3).AddTile(TileID.Anvils).Register();
        }
    }
}
