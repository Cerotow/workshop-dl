...
{
    public class IronSpikeStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<IronSpikeBall>();
            Item.shootSpeed = 2;
            Item.buffType = ModContent.BuffType<IronSpikeBallBuff>();
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.IronBar, 6).AddIngredient(ModContent.ItemType<SoulOfNature>(), 2).AddIngredient(9, 2).AddTile(TileID.Anvils).Register();
        }
    }
}
