...
{
    public class CopperSwordStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<CopperSword>();
            Item.shootSpeed = 2;
            Item.buffType = ModContent.BuffType<CopperSwordBuff>();
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.CopperBar,6).AddIngredient(ModContent.ItemType<SoulOfNature>(),2).AddIngredient(9,2).AddTile(TileID.Anvils).Register();
        }
    }
}
