...
namespace DDmod.Content.Items.农场.食物
{
	public class 烤土豆 : ModItem
	{
		public override void SetDefaults()
		{
			...
			Item.GetGlobalItem<FoodGlobalItem>().移速buff(0.05f,DDHelper.Second(300));
			Item.GetGlobalItem<FoodGlobalItem>().挖掘buff(0.1f,DDHelper.Second(300));
