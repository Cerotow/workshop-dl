...
namespace DDmod.Content.Items.Boss.鬼牙
{
    public class 鬼牙宝藏袋 : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<鬼牙手环>()));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<鬼牙面具>(),10));

            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<鬼牙头>()));
        }
