...
namespace DDmod.Content.Items.Boss.蘑菇王
{
    public class 蘑菇王宝藏袋 : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            int[] A =
            [
            ModContent.ItemType<蘑菇短剑>(),
            ModContent.ItemType<蘑菇弓>(),
            ModContent.ItemType<蘑菇杖>(),
            ModContent.ItemType<蘑菇鞭>(),
            ];
            itemLoot.NormalLoot(1, 1, 1, 1, A);

            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<生命蘑菇>()));
            
            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<NPCs.Boss.蘑菇王.蘑菇王>()));
        }
