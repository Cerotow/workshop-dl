...
namespace DDmod.Content.Items.Boss.天雷怒云
{
    public class 天雷怒云宝藏袋 : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            //面具
            itemLoot.NormalLoot(10, ModContent.ItemType<天雷怒云面具>());

            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<雷霆令牌>()));

            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<NPCs.Boss.天雷怒云.天雷怒云>()));
        }
