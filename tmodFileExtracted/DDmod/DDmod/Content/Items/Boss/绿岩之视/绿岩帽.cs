...
namespace DDmod.Content.Items.Boss.绿岩之视
{
	...
	public class 绿岩帽 : ModItem
	{
        ...
        {
            DDSystem.Instance.DDEquipGlow.TryGetValue("绿岩帽", out int GG);
            glowMask = GG;
		...
		public override void UpdateArmorSet(Player player)
        {
            ...
            player.setBonus = Language.GetTextValue("Mods.DDmod.ItemArmorSet.远程绿岩套");
			player.Aplayer().绿岩套 = 3;
        }
