...
namespace DDmod.Content.Items.Boss.先祖咒魂
{
    public class 先祖咒魂宝藏袋 : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            //面具
            itemLoot.NormalLoot(10, ModContent.ItemType<先祖咒魂面具>());

            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<诅咒之火>()));

            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<NPCs.Boss.先祖咒魂.先祖咒魂>()));
        }
