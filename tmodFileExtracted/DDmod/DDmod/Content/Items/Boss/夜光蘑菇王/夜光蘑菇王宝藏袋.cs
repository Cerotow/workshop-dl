...
namespace DDmod.Content.Items.Boss.夜光蘑菇王
{
    public class 夜光蘑菇王宝藏袋 : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.NormalLoot(1, 1, 120, 300, ModContent.ItemType<夜光蘑菇炸弹>());

            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<魔法菇>()));
            
            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<NPCs.Boss.夜光蘑菇王.夜光蘑菇王>()));
        }
