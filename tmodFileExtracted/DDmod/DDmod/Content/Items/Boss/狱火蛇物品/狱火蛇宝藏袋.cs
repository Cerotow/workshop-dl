...
namespace DDmod.Content.Items.Boss.狱火蛇物品
{
    public class 狱火蛇宝藏袋 : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<狱火戒>()));


            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<狱火蛇头>()));
        }
