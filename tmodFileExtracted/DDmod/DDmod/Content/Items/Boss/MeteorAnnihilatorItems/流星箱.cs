...
namespace DDmod.Content.Items.Boss.MeteorAnnihilatorItems
{
    public class 流星箱 : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<流星冲刺翼>()));

            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<MeteorAnnihilator>()));
        }
