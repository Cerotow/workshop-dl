...
{
    public class SuspiciousStarStone : ModItem
    {
        ...
        {
            return !AnyNPCs(ModContent.NPCType<StarGuard>());
        }

        public override bool? UseItem(Player player)
        {
            int T = ModContent.NPCType<StarGuard>();
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.ManaCrystal).AddTile(TileID.WorkBenches).Register();
        }
    }
}
