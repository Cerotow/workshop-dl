...
namespace DDmod.Content.Items.Potion
{
	public class 纷争药水 : ModItem
	{
        public override void SetDefaults()
        {
            ...
            Item.useTurn = true;
            Item.buffType = ModContent.BuffType<纷争药水Buff>();
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<战争药水>(), 1).AddIngredient(520, 3).AddIngredient(521, 3).AddTile(13).Register();
        }
    }
}