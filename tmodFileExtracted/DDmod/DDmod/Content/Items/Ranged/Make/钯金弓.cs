...
namespace DDmod.Content.Items.Ranged.Make
{
	public class 钯金弓 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.GetGlobalItem<RangedGlobalItem>().SetString(5,5,3,0,6,false, new Color(247, 214, 196));
		}
		...
		{
			CreateRecipe(1).AddIngredient(1184, 12).AddTile(TileID.Anvils).Register();
        }
