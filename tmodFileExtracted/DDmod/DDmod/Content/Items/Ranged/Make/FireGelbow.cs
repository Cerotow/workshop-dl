...
{
	public class FireGelbow : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.GetGlobalItem<RangedGlobalItem>().PostConvertArrows = ProjectileID.FireArrow;
        ...
        public override void Update(ref float gravity, ref float maxFallSpeed)
		{
			...
			Dust dust =Main.dust[NewDust(Item.position, Item.width, Item.height, 6,0,0,0,default,Main.rand.NextFloat(0.8F,1.5F))];
