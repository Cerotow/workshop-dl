...
namespace DDmod.Content.Items.Ranged.Make.Gun
{
	public class 钨制霰弹枪 : ModItem
	{
		public override void SetDefaults()
		{
			...
			Item.knockBack = 1;
            Item.value = Item.buyPrice(0, 0, 28, 0);
            Item.rare = 1;
            ...
            Item.shoot = ModContent.ProjectileType<钨制霰弹枪Proj>();
            Item.channel = true;
        ...
        {
            CreateRecipe(1).AddIngredient(705, 12).AddIngredient(ModContent.ItemType<钢锭>(), 6).AddIngredient(324,1).AddTile(16).Register();
        }
    }
}