...
namespace DDmod.Content.Items.Ranged.Make.Gun
{
	public class 神圣裁决 : ModItem
	{
		public override void SetDefaults()
		{
            ...
            Item.shoot = ModContent.ProjectileType<神圣裁决Proj>();
            Item.channel = true;
        ...
        {
            CreateRecipe(1).AddIngredient(1225,12).AddIngredient(ModContent.ItemType<钢锭>(), 6).AddIngredient(549, 3).AddIngredient(38, 3).AddIngredient(324, 1).AddTile(TileID.MythrilAnvil).Register();
        }
    }
}