...
namespace DDmod.Content.Items.Ranged.Make.Gun
{
	public class 爆裂熔岩 : ModItem
	{
		public override void SetDefaults()
		{
            ...
            Item.shoot = ModContent.ProjectileType<爆裂熔岩Proj>();
            Item.channel = true;
        ...
        {
            CreateRecipe(1).AddIngredient(175, 12).AddIngredient(ModContent.ItemType<钢锭>(), 6).AddIngredient(324, 1).AddTile(TileID.Anvils).Register();
        }
    }
}