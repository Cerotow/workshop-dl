...
namespace DDmod.Content.Items.Ranged.Make.Gun
{
	public class 钛金手枪 : ModItem
	{
		public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<钛金手枪Proj>();
            Item.channel = true;
        ...
        {
            CreateRecipe(1).AddIngredient(1198, 12).AddIngredient(ModContent.ItemType<钢锭>(), 6).AddIngredient(324, 1).AddTile(TileID.MythrilAnvil).Register();
        }
    }
}