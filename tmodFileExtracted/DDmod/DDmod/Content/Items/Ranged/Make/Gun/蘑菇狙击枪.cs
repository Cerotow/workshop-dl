...
namespace DDmod.Content.Items.Ranged.Make.Gun
{
	public class 蘑菇狙击枪 : ModItem
	{
		public override void SetDefaults()
		{
            ...
            Item.shoot = ModContent.ProjectileType<蘑菇狙击枪Proj>();
            Item.channel = true;
        ...
        {
            CreateRecipe(1).AddIngredient(1254, 1).AddIngredient(1552, 12).AddIngredient(1508, 3).AddTile(TileID.MythrilAnvil).Register();
        }
    }
}