...
namespace DDmod.Content.Items.Ranged.Make.Gun
{
	public class 神圣霰弹枪 : ModItem
	{
		public override void SetDefaults()
		{
            ...
            Item.knockBack = 1;
            Item.value = Item.buyPrice(0, 10, 25, 0);
            Item.rare = 6;
            ...
            Item.shoot = ModContent.ProjectileType<神圣霰弹枪Proj>();
            Item.channel = true;
        ...
        {
            CreateRecipe(1).AddIngredient(1225, 12).AddIngredient(ModContent.ItemType<钢锭>(), 6).AddIngredient(324, 1).AddTile(TileID.MythrilAnvil).Register();
        }
    }
}