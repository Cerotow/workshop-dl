...
namespace DDmod.Content.Items.Ranged.Make.Gun
{
	public class 秘银双管猎枪 : ModItem
	{
		public override void SetDefaults()
		{
            ...
            Item.shoot = ModContent.ProjectileType<秘银双管猎枪Proj>();
            Item.channel = true;
        ...
        {
            CreateRecipe(1).AddIngredient(382, 12).AddIngredient(ModContent.ItemType<钢锭>(), 6).AddIngredient(324, 1).AddTile(TileID.MythrilAnvil).Register();
        }
    }
}