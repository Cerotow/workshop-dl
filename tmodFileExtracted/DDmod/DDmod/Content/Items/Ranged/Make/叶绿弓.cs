...
namespace DDmod.Content.Items.Ranged.Make
{
	public class 叶绿弓 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.GetGlobalItem<RangedGlobalItem>().SetArrows(new int[] { 1}, ModContent.ProjectileType<叶绿光箭>());
			Item.GetGlobalItem<RangedGlobalItem>().SetString(5,5,3,0,10,false, new Color(186, 86, 88));
		}
        ...
        {
            CreateRecipe(1).AddIngredient(1006, 12).AddTile(TileID.MythrilAnvil).Register();
        }
        public class Modify : ModifyBow
        {
            ...
            public override void Shoot(Item item, Projectile Projectile, RangedGlobalItem rangedItem, RangedProjectile ranged)
            {
                ...
                if (Projectile.owner == Main.myPlayer)
                {
                    ...
                    NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center - new Vector2(0, Main.rand.Next(10,30)).RotatedBy(Projectile.rotation), Projectile.velocity * 10, ModContent.ProjectileType<叶绿光箭>(), (int)(ranged.BowDamage[0] * Magnification), 0);
                    NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center + new Vector2(0, Main.rand.Next(10, 30)).RotatedBy(Projectile.rotation), Projectile.velocity * 10, ModContent.ProjectileType<叶绿光箭>(), (int)(ranged.BowDamage[0] * Magnification), 0);
                }
            }
            /// <summary>
