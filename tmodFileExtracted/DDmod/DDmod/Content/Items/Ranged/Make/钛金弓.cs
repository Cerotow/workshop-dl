...
namespace DDmod.Content.Items.Ranged.Make
{
	public class 钛金弓 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.GetGlobalItem<RangedGlobalItem>().SetString(5,5,3,0,6,false, new Color(214, 255, 255));
		}
        ...
        {
            CreateRecipe(1).AddIngredient(1198, 10).AddTile(TileID.MythrilAnvil).Register();
        }
