...
namespace DDmod.Content.Items.Ranged.Make
{
	public class 山铜弓 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.GetGlobalItem<RangedGlobalItem>().SetString(5,5,3,0,6,false, new Color(219, 197, 228));
		}
        ...
        {
            CreateRecipe(1).AddIngredient(1191, 10).AddTile(TileID.MythrilAnvil).Register();
        }
