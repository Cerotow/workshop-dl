...
namespace DDmod.Content.Items.Tiles.晶凝
{
    public class 晶凝门 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<晶凝门关Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<晶凝石块>(), 6).AddTile(TileID.WorkBenches).Register();
        }
    }
}