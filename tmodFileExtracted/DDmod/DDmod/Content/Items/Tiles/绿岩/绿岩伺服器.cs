...
namespace DDmod.Content.Items.Tiles.绿岩
{
    public class 绿岩伺服器 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<绿岩伺服器Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<绿岩砖>(), 40).AddIngredient(ModContent.ItemType<绿岩电池>(), 3).AddTile(TileID.Anvils).Register();
        }
    }
}