...
namespace DDmod.Content.Items.Tiles.绿岩
{
    public class 绿岩操作台 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<绿岩操作台Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<绿岩砖>(), 50).AddIngredient(ModContent.ItemType<绿岩锭>(), 16).AddIngredient(ModContent.ItemType<绿岩电池>(), 5).AddTile(TileID.Anvils).Register();
        }
    }
}