...
namespace DDmod.Content.Items.Tiles.绿岩
{
    public class 绿岩浴缸 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<绿岩浴缸Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<绿岩砖>(), 14).AddTile(TileID.Sawmill).Register();
        }
    }
}