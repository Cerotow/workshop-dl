...
namespace DDmod.Content.Items.Tiles.绿岩
{
    public class 绿岩挂顶灯 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<绿岩挂顶灯Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<绿岩砖>(), 6).AddIngredient(8, 1).AddTile(TileID.WorkBenches).Register();
        }
    }
}