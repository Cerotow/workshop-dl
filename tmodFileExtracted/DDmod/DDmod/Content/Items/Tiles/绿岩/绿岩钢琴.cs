...
namespace DDmod.Content.Items.Tiles.绿岩
{
    public class 绿岩钢琴 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<绿岩钢琴Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<绿岩砖>(), 15).AddIngredient(154, 4).AddIngredient(149, 1).AddTile(TileID.Sawmill).Register();
        }
    }
}