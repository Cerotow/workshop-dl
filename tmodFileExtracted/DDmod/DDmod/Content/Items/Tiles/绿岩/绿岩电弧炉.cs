...
namespace DDmod.Content.Items.Tiles.绿岩
{
    public class 绿岩电弧炉 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<绿岩电弧炉Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<绿岩砖>(), 20).AddIngredient(ModContent.ItemType<绿岩锭>(), 20).AddIngredient(ModContent.ItemType<绿岩电池>(), 5).AddTile(TileID.Anvils).Register();
        }
    }
}