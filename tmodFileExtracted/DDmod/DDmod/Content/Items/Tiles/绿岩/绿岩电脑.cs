...
namespace DDmod.Content.Items.Tiles.绿岩
{
    public class 绿岩电脑 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<绿岩电脑Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<绿岩砖>(), 20).AddIngredient(ModContent.ItemType<绿岩电池>(), 2).AddTile(TileID.Anvils).Register();
        }
    }
}