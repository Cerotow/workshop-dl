...
namespace DDmod.Content.Items.Tiles.绿岩
{
    public class 绿岩门 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<绿岩门关Tile>();
            Item.placeStyle = 0;
        }
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<绿岩砖>(), 6).AddTile(TileID.WorkBenches).Register();
        }
    }
}