...
{
    public class RubySword : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (player.ActiveItem().type != ModContent.ItemType<RubySwordItem>())
            {
                return false;
            }
            RubySwordItem sword = (RubySwordItem)(player.ActiveItem().ModItem);
        ...
        Color color = new Color(255, 20, 0, 120) * 0.67f;
