...
{
    public class DiamondSword : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (player.ActiveItem().type != ModContent.ItemType<DiamondSwordItem>())
            {
                return false;
            }
            DiamondSwordItem sword = (DiamondSwordItem)(player.ActiveItem().ModItem);
            ...
            {
                Projectile.HoldSword2(player, -player.HeldItem.useAnimation * (Projectile.extraUpdates + 1), 126, MathHelper.TwoPi + 2.5F, true);
            }
        ...
        Color color = new Color(200, 180, 240, 120) * 0.67f;
