namespace DDmod.Content.Projectiles.Melee
{
    public class AmethystBeam : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(219, 97, 255, 0);
            ...
            for (int a = 0; a < Projectile.ai[0]; a++)
            {
                ...
                Main.spriteBatch.Draw(texture, Projectile.position + vector - Main.screenPosition, null, color, Projectile.rotation, new Vector2(texture.Width, 0), Projectile.ai[0] / 2, spriteEffects, 0f);
            }
            return false;
        }
    }
