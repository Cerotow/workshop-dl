...
{
    public class SycamoreBunnySlime : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (Projectile.ai[1] == 1)
            {
                ...
                for (int a = 0; a < 3; a++)
                {
                    ...
                    Main.EntitySpriteDraw(DDTextures.Circle[7].Value, Projectile.Center + projDirection - Main.screenPosition, null, new Color(173, 114, 73, 0) * (1 - T1), Projectile.rotation, DDTextures.Circle[7].Size() / 2, new Vector2(Projectile.scale * 0.8f, 0.2f) * T1, 0, 0);
                    Main.EntitySpriteDraw(DDTextures.Circle[7].Value, Projectile.Center + projDirection - Main.screenPosition, null, new Color(173, 114, 73, 0) * (1 - T2), Projectile.rotation, DDTextures.Circle[7].Size() / 2, new Vector2(Projectile.scale * 0.8f + 0.01F, 0.21f) * T2, 0, 0);
                    Main.EntitySpriteDraw(DDTextures.Circle[7].Value, Projectile.Center + projDirection - Main.screenPosition, null, new Color(173, 114, 73, 0) * (1 - T3), Projectile.rotation, DDTextures.Circle[7].Size() / 2, new Vector2(Projectile.scale * 0.8f + 0.02F, 0.22f) * T3, 0, 0);
                }
            }
            return false;
        }
        public override void AI()
        {
            ...
            if (Projectile.ai[1] == 1)
            {
                if (player.dead || !player.HasBuff(ModContent.BuffType<SycamoreBunnySlimeBuff>())) return;
            ...
            if (!player.dead && Main.rand.NextBool(1000) && !player.sleeping.FullyFallenAsleep)
            {
                string text;
                if (DDSystem.English)
                {
                ...
                //CombatText.NewText(new Rectangle((int)Projectile.Center.X, (int)Projectile.Center.Y, 1, 1), new Color(80,222,232, 255), text, false, false);
            }
        }
        private void CheckActive(Player player)
        {
            if (player.HasBuff(ModContent.BuffType<SycamoreBunnySlimeBuff>()))
            {
