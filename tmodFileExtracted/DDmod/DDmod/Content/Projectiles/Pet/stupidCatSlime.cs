...
{
    public class stupidCatSlime : ModProjectile
    {
        ...
        {
            Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("DDmod/Content/Projectiles/Pet/stupidCatSlime_Tail");
        ...
        public override void AI()
        {
            ...
            {
                Tailframe2 = 0;
                DDHelper.BackAndForthInt(1, 3, 1, ref Tailframe, ref Projectile.DProj().Bool[0]);
            }
            ...
            if (Projectile.ai[1] == 1)
            {
                if (player.dead || !player.HasBuff(ModContent.BuffType<stupidCatSlimeBuff>())) return;
        ...
        {
            if (player.HasBuff(ModContent.BuffType<stupidCatSlimeBuff>()))
            {
