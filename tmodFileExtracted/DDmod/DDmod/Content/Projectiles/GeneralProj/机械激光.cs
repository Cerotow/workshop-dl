...
{
    public class 机械激光 : ModProjectile
    {
        ...
        {
            NewDustChange4(30, Projectile.Center, Vector2.Zero, ModContent.DustType<光球粒子>(), 0, 4, true, 0.4F, 1.2F, 100, 0, new Color(255, 100, 100, 0), -2);
        }
