        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.localAI[0] == 0)
            {
                ...
                for (int i = 0; i < Projectile.oldPos.Length; i++)
                {
                    ...
                    Color color = new Color(255, 155, 0, 0) * ((Projectile.oldPos.Length - i) / (float)Projectile.oldPos.Length / 2f);
                ...
                Main.spriteBatch.Draw(texture, Projectile.position + vector - Main.screenPosition, null, new Color(255, 155, 0, 0), Projectile.rotation, texture.Size() / 2, Projectile.scale, spriteEffects, 0f);
                Main.spriteBatch.Draw(texture, Projectile.position + vector - Main.screenPosition, null, new Color(0, 100, 255, 0), Projectile.rotation, texture.Size() / 2, Projectile.scale / 1.5F, spriteEffects, 0f);
            }
            return false;
        }
    }
