...
{
    public class AmberStaff : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(255, 196, 48, 0);
            for (int a = 0; a < 3; a++)
            {
