...
{
    public class PoisonStaff : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            else if (Projectile.ai[0] > player.ActiveItem().useAnimation && Main.myPlayer == Projectile.owner)
            {
                ...
                NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center + Projectile.velocity.PerfectNormalize() * Projectile.SolidTileDistanceDetection(Main.rand.NextFloat(10, 15), 50) + new Vector2(0, Main.rand.NextFloat(-30, 30)).RotatedBy(Projectile.rotation - MathHelper.PiOver4), Projectile.velocity * Main.rand.NextFloat(10,15),265, Projectile.damage, 0, Projectile.owner, Projectile.whoAmI);
            }
            return false;
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(66, 53, 55, 0)*0.5f;
