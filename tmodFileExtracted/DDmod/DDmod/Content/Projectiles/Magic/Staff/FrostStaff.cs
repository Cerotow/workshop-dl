...
{
    public class FrostStaff : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.ai[1] >= player.ActiveItem().MagicItem().charging)
            {
                Main.spriteBatch.Draw(texture, vector2 - Projectile.velocity.PerfectNormalize() * -16 * T1, new Rectangle?(new Rectangle(0, 0, texture.Width, texture.Height)), color, 0f, Utils.Size(texture) / 2, Projectile.ai[1] / 2 * (1-T1)/4, 0, 0);
                Main.spriteBatch.Draw(texture, vector2 - Projectile.velocity.PerfectNormalize() * -16 * T2, new Rectangle?(new Rectangle(0, 0, texture.Width, texture.Height)), color, 0f, Utils.Size(texture) / 2, Projectile.ai[1] / 2 * (1-T2)/4, 0, 0);
                Main.spriteBatch.Draw(texture, vector2 - Projectile.velocity.PerfectNormalize() * -16 * T3, new Rectangle?(new Rectangle(0, 0, texture.Width, texture.Height)), color, 0f, Utils.Size(texture) / 2, Projectile.ai[1] / 2 * (1-T3)/4, 0, 0);
            }
