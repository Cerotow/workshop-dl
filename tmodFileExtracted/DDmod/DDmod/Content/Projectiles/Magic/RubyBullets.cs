...
{
    public class RubyBullets : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] == 0 && (Projectile.localAI[1] >= 1 || Projectile.timeLeft < 3))
            {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (Projectile.localAI[0] == 0)
            {
                ...
                for (int i = 0; i < Projectile.oldPos.Length; i++)
                {
                    ...
                    Color color = new Color(255, 50, 50, 0) * ((Projectile.oldPos.Length - i) / (float)Projectile.oldPos.Length / 2f);
                ...
                Main.spriteBatch.Draw(texture, Projectile.position + vector - Main.screenPosition, null, new Color(255, 50, 50, 0), Projectile.rotation, texture.Size() / 2, Projectile.scale, spriteEffects, 0f);
                Main.spriteBatch.Draw(texture, Projectile.position + vector - Main.screenPosition, null, new Color(0, 205, 205, 0), Projectile.rotation, texture.Size() / 2, Projectile.scale / 1.5F, spriteEffects, 0f);
            }
            return false;
        }
    }
