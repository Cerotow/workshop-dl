    ...
    public class WaterBolt : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (Projectile.ai[0] >= player.HeldItem.useAnimation && Projectile.DProj().Bool[1])
            {
                ...
                {
                    Projectile proj = Main.projectile[NewProjectileChange(Projectile.GetSource_FromThis(), Projectile.Center, vector2 * 13, 27, Projectile.damage, Projectile.knockBack, Projectile.owner, vector2.Y * 8, 0, 1)];
                }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int A = 0; A < 2; A++)
            {
                Color color = new Color(0, 55, 255, 0);
