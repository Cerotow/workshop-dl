    ...
    public class BookofSkulls : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (Projectile.ai[0] >= player.HeldItem.useAnimation && Projectile.DProj().Bool[1])
            {
                ...
                {
                    Projectile proj = Main.projectile[NewProjectileChange(Projectile.GetSource_FromThis(), Projectile.Center, vector2 * 3, 837, Projectile.damage, Projectile.knockBack, Projectile.owner, 0, 0, 1)];
                }
