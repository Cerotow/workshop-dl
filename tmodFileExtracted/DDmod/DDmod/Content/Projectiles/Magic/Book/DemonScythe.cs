    ...
    public class DemonScythe : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (Projectile.ai[0] >= player.HeldItem.useAnimation && Projectile.DProj().Bool[1])
            {
                ...
                {
                    Projectile proj = Main.projectile[NewProjectileChange(Projectile.GetSource_FromThis(), Projectile.Center, vector2 * 1, 45, Projectile.damage, Projectile.knockBack, Projectile.owner, vector2.Y * 8, 0, 1)];
                }
