...
namespace DDmod.Content.Projectiles.Boss.MiniBoss
{
    public class Boss星尘光束 : 闪电
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] > 60)
            {
                ...
                else
                {
                    ...
                    {
                        Dust dust3 = Main.dust[NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<速度粒子>(), Projectile.oldVelocity.X, Projectile.oldVelocity.Y, 255, new Color(40, 185, 255, 0))];
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.ai[1] < 60)
            {
                Main.spriteBatch.Draw(DDTextures.Wire.Value, Projectile.Center - Main.screenPosition, null, new Color(40, 185, 255, 0) *0.5f, Projectile.velocity.ToRotation(), new Vector2(0, 1), new Vector2(12, 4), 0, 0f);

                return false;
            }
            SpriteEffects spriteEffects = 0;
            Texture2D texture = DDTextures.MiniVoidStar.Value;
            Color color = new Color(40, 185, 255, 0);
