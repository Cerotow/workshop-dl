        ...
        public override void AI()
        {
			...
			if (Projectile.ai[0] > 35f)
			{
				...
				if(target != null)
                {
					...
					Vector2 vectToTarget = (target.Center - Projectile.Center).SafeNormalize(-Vector2.UnitY) * 16f;
					Projectile.velocity = Vector2.Lerp(Projectile.velocity, vectToTarget, 0.12f);
				}
			}
		}
