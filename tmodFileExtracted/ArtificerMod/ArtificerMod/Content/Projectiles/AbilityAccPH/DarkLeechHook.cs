	...
	public class DarkLeechHook : ModProjectile
	{
		...
		public void Lifesteal(NPC target)
		{
			if (Projectile.owner == Main.myPlayer)
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, Projectile.velocity * 0f, ModContent.ProjectileType<DarkLeechHeal>(), 0, 0f, Projectile.owner, healTargetID, 4f);
			}
		}
