...
namespace ArtificerMod.Content.Items.ArmorH
{
	...
	public class RadiantFacemask : ModItem
	{
		...
		public override void UpdateArmorSet(Player player)
		{
            ...
            string bonusDesc = Language.GetTextValue("Mods.ArtificerMod.CommonItemtooltip.Armorset.Radiant").FormatWith(bonusTrigger);

            if (CrossModHelper.CaptureTrailLength(0.05f, player))
            {
                bonusDesc += "\n" + CrossModHelper.GetCrossmodText("CaptureClass.IncTrailLength", 5);
            }
