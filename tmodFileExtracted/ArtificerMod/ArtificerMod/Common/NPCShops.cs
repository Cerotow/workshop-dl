...
namespace ArtificerMod.Common
{
	class ArsenalShop : GlobalNPC
	{
		public override void ModifyShop(NPCShop shop)
		{
			...
			{
                shop.Add<PygmyBracer>(Condition.TimeNight);
        ...
        public override void SetupTravelShop(int[] shop, ref int nextSlot)
        {
            ...
            {
                shop[nextSlot++] = ModContent.ItemType<GamblerFallacy>();
            }
		...
		/// <summary>
		/// Used to determine if the Travelling Merchant should sell the Lucky Star. It is unique in that it becomes more common as (pre-hardmode) bosses are defeated.
		/// </summary>
