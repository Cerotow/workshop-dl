...
namespace ArtificerMod.Common
{
	...
	public class ArtificerLoot : GlobalNPC
	{
		public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
		{
			...
			{
				npcLoot.Add(ItemDropRule.ByCondition(frostMoonRNG, ModContent.ItemType<LuckyPresent>(), 25));
			}
			if (npc.type == NPCID.PresentMimic)
			{
				npcLoot.Add(ItemDropRule.ByCondition(frostMoonRNG, ModContent.ItemType<LuckyPresent>(), 50));
			}
			...
			{
				npcLoot.Add(ItemDropRule.ByCondition(frostMoonRNG, ModContent.ItemType<LuckyPresent>(), 200));
			}
